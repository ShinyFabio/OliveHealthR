...
<strong>4. Install devtools if not already installed. Click yes if R asks you something.</strong>
...
<strong>5. Now you can install OliveHealthR from [GitHub](https://github.com/ShinyFabio/OliveHealthR2) with:</strong>
