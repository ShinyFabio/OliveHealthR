...
```
Be sure that your R version is at least 4.0.0. Click yes if R asks you something.
...
```
Se R ti chiede di installare i pacchetti che richiedono compilazione clicca su "No". Una volta completata l'installazione,
dovrai riscaricare le foto (vedi step 6 dell'installazione).
