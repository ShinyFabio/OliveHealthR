...
4. Install devtools if not already installed. Click yes if R asks you something.
...
5. Now you can install OliveHealthR from [GitHub](https://github.com/ShinyFabio/OliveHealthR2) with:
...
6. When installation is completed, you can launch this code if you want to download all the olives photos (this step is optional):
