...
- __"Codice_azienda"__ same
- __"N_campionamento"__ filled with "R1" or "R2" where R1 refers to the first sampling (September/October) abd R2 refers to the last sampling (end of October/ beginning of November so when the olives are completely ripe)
